...
#Para saber cuantos meses hay en la carpeta de datos 
#allFileNames = "/RAW_NA_000_"+"*"
#allFilenames = sorted(glob.glob(path+allFileNames))
#Fisrtmonth = allFileNames[0][77:79]
#Lastmonnth = allFileNames[-1][77:79]
...
np.savetxt("QroMatrix{},{}.csv".format(dateS.year,dateS.month), dataMatriz, delimiter=",")
cmap=pl.cm.viridis
cmap.set_bad(color='white')
