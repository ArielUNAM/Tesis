...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov  5 21:46:20 2017
...
os.chdir('/home/amagaldi/Desktop/Radares/Catedral/2015/')
print os.getcwd()
path =r'/home/amagaldi/Desktop/Radares/Catedral/2015/'



d1 = date(2015, 8, 15)  # start date
d2 = date(2015, 8, 31)  # end date

delta = d2 - d1         # timedelta

for i in range(delta.days + 1):
    dat=d1 + timedelta(days=i)
    ase="CAT15"+'%02d'%dat.month+'%02d'%dat.day+"*"
...
#    pl.ylabel("Northing (m)")
    ...
    xy = np.stack((lon3,lat3), axis=-1)



    data = gridded
    ds = wrl.georef.create_raster_dataset(data, xy)
    path2 =r'/home/amagaldi/Desktop/Radares'
    wrl.io.write_raster_dataset(path2+ase2, ds, 'GTiff')

# =============================================================================
# from osgeo import gdal
# ds1 = wrl.io.open_raster(path  + "geotiff.tif")
# data1, xy1, proj1 = wrl.georef.extract_raster_dataset(ds, nodata=-9999.)
# =============================================================================
